...
func main() {
	...
	registerRoute(mux, "/distil/results-variable-extrema/:dataset/:variable/:results-uuid", routes.ResultVariableExtremaHandler(pgSolutionStorageCtor, pgDataStorageCtor))
	registerRoute(mux, "/distil/predicted-extrema/:dataset/:results-uuid", routes.PredictedExtremaHandler(pgSolutionStorageCtor, pgDataStorageCtor))
	registerRoute(mux, "/distil/residuals-extrema/:dataset/:results-uuid", routes.ResidualsExtremaHandler(pgSolutionStorageCtor, pgDataStorageCtor))
	...
	registerRoutePost(mux, "/distil/results-variable-summary/:dataset/:variable/:min/:max/:results-uuid", routes.ResultVariableSummaryHandler(pgSolutionStorageCtor, pgDataStorageCtor))
	registerRoutePost(mux, "/distil/residuals-summary/:dataset/:min/:max/:results-uuid", routes.ResidualsSummaryHandler(pgSolutionStorageCtor, pgDataStorageCtor))
	...
	registerRoutePost(mux, "/distil/predicted-summary/:dataset/:min/:max/:results-uuid", routes.PredictedSummaryHandler(pgSolutionStorageCtor, pgDataStorageCtor))
