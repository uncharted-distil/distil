...
func main() {
	...
	registerRoutePost(mux, "/distil/predict/:dataset/:fitted-solution-id", routes.UploadHandler(path.Join(config.D3MOutputDir, config.AugmentedSubFolder), ingestConfig))
