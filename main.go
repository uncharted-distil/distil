...
func main() {
	...
	registerRoute(mux, "/distil/results-summary/:index/:dataset/:pipeline-id", routes.ResultsSummaryHandler(pgPipelineStorageCtor, pgDataStorageCtor))
	registerRoute(mux, "/distil/residuals-summary/:index/:dataset/:pipeline-id", routes.ResidualsSummaryHandler(pgPipelineStorageCtor, pgDataStorageCtor))
