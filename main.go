...
func main() {
	...
	registerRoutePost(mux, "/distil/clone/:produce-request-id/:dataset-name", routes.CloningResultsHandler(esMetadataStorageCtor, pgDataStorageCtor, pgSolutionStorageCtor, config))
	registerRoutePost(mux, "/distil/clone-result/:dataset", routes.CloningHandler(esMetadataStorageCtor, pgDataStorageCtor, config))
