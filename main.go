...
func main() {
	...
	registerRoute(mux, "/distil/prediction/:prediction-id", routes.SolutionHandler(pgSolutionStorageCtor))
	registerRoute(mux, "/distil/predictions/:fitted-solution-id", routes.SolutionsHandler(pgSolutionStorageCtor))
	registerRoute(mux, "/distil/prediction-requests/:fitted-solution-id", routes.SolutionRequestsHandler(pgSolutionStorageCtor))
	registerRoute(mux, "/distil/prediction-requests/:request-id", routes.SolutionRequestHandler(pgSolutionStorageCtor))
