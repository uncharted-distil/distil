...
func main() {
	...
	registerRoute(mux, "/distil/results-extrema/:index/:dataset/:results-uuid", routes.ResidualsExtremaHandler(pgPipelineStorageCtor, pgDataStorageCtor))
	...
	registerRoute(mux, "/distil/residuals-extrema/:index/:dataset/:results-uuid", routes.ResultsExtremaHandler(pgPipelineStorageCtor, pgDataStorageCtor))
