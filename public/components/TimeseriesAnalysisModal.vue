<template>
	<div>
		<b-modal
			...
			<div class="row justify-content-center">
				<b-btn class="mt-3 timeseries-modal-button" variant="outline-success" block @click="onClose(true)">Yes</b-btn>
				<b-btn class="mt-3 timeseries-modal-button" variant="outline-secondary" block @click="onClose(false)">No</b-btn>
			</div>
		</b-modal>
	</div>
