  ...
  methods: {
    ...
    paint() {
      ...
      if (bounds.isValid()) {
        ...
        const sideDistance = turf.distance(bboxVertexCoordA, bboxVertexCoordB, {
          units: 'kilometers'
        });
        ...
        const maxVal = _.maxBy(count.features, i => i.properties.z).properties.z
          .length;
        const minVal = _.minBy(count.features, i => i.properties.z).properties.z
          .length;
