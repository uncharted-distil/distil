...
export interface Task {
	...
	defaultMetrics: Dictionary<NameInfo>
};
...
export function getDefaultMetricDisplayNames(task: Task): string[] {
	return _.map(_.get(task, 'defaultMetrics', []), (s: NameInfo) => s.displayName);
}
...
const defaultClassificationMetrics: Dictionary<NameInfo> = {
	rSquared: classificationMetrics.accuracy
}
...
const defaultRegressionMetrics: Dictionary<NameInfo> = {
...
const classification: Task = {
	...
	defaultMetrics: defaultClassificationMetrics
};
...
const regression: Task = {
	...
	defaultMetrics: defaultRegressionMetrics
};
