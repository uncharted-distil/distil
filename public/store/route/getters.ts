...
import { JoinPair, AccuracyData, minimumRouteKey } from "../../util/data";
...
export const getters = {
  ...
  getJoinPairs(state: Route): JoinPair<string>[] {
  ...
  getJoinInfo(state: Route): AccuracyData[] {
    const value = state.query.joinInfo;
