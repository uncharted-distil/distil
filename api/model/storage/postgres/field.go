...
type Field interface {
	...
	FetchTimeseriesSummaryData(timeVar *api.Variable, interval int, resultURI string, filterParams *model.FilterParams, extrema *model.Extrema) (*model.Histogram, error)
