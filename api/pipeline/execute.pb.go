...
func (*PipelineExecuteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_execute_d850031e86bb84a9, []int{0}
}
...
func (*PipelineExecuteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_execute_d850031e86bb84a9, []int{1}
}
...
func init() { proto.RegisterFile("execute.proto", fileDescriptor_execute_d850031e86bb84a9) }

var fileDescriptor_execute_d850031e86bb84a9 = []byte{
