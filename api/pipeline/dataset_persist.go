...
// is returned.
func PersistFilteredData(fetchData FilteredDataProvider, datasetDir string, dataset string, index string, target string, filters *model.FilterParams, inclusive bool) (string, error) {
