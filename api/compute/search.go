...
func (s *SolutionRequest) dispatchSolutionSearchPipeline(statusChan chan SolutionStatus, client *compute.Client, solutionStorage api.SolutionStorage,
	dataStorage api.DataStorage, initialSearchID string, solutionID string, dataset string, storageName string,
	...
	s.persistSolutionStatus(statusChan, solutionStorage, initialSearchID, solutionID, SolutionFittingStatus)
	...
	s.persistSolutionStatus(statusChan, solutionStorage, initialSearchID, solutionID, SolutionScoringStatus)
	...
	s.persistSolutionStatus(statusChan, solutionStorage, initialSearchID, solutionID, SolutionProducingStatus)
	...
	for _, response := range predictionResponses {
		...
		s.persistSolutionResults(statusChan, client, solutionStorage, dataStorage,
			initialSearchID, dataset, storageName, solutionID, solutionID, fittedSolutionID,
